...
async def query_agent(query_text, conversation_id=None):
...
async def main():
    ...
    # Test queries with explicit RAG instructions
    queries = [
        "use the rag plugin to search for onward platforms",
        "call the rag agent to search for rodney pressley",
        "search the documents for information about the agreement",
        "use rag.search_documents to find information about the NDA"
    ]
